...
const AlarmMissions = ({navigation, route}) => {
  ...
  const setModifiedAlarm = () => {
    ...
    if (isSelectedPicture) {
      // console.log('true?', isSelectedPicture);
      modifiedAlarm.alarm_picture = 'true';
    } else {
      // console.log('false?', isSelectedPicture);
    ...
    // console.log(
    //   '사진: ',
    //   modifiedAlarm.alarm_picture,
    //   ' / 가위바위보: ',
    //   modifiedAlarm.alarm_rps,
    //   ' / 수학: ',
    //   modifiedAlarm.alarm_math,
    //   ' / 카드: ',
    //   modifiedAlarm.alarm_card,
    // );
  };
