...
class AlarmControl extends Component {
  ...
  componentDidMount() {
    console.log('componentDidMount 11111111111111111');
    this._subscribeDismiss = RNEmitter.addListener(
      'OnNotificationDismissed',
      data => {
        console.log('componentDidMount 22222222');
    ...
    this._subscribeOpen = RNEmitter.addListener(
      ...
      data => {
        console.log('componentDidMount 333333333333');
        console.log(data);
        const obj = JSON.parse(data);
