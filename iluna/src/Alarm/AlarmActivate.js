...
class AlarmActivate extends Component {
  ...
  constructor(props) {
    ...
    console.log('잘오니??', props.route.params.isNoti);
    ...
    //     if (success.length >= 1) {
    //       console.log(success);
    //       // this.noonOrNot(success[0]['alarm_time']);
    //       // this.setDate();

    //       // if (success[0]['alarm_picture'] == 'true') {
    //       //   tmp.push(['Photo', 0]);
    //       // }
    //       // if (success[0]['alarm_rps'] == 'true') {
    //       //   tmp.push(['RPS', 0]);
    //       // }
    //       // if (success[0]['alarm_math'] * 1 > 0) {
    //       //   tmp.push(['Math', success[0]['alarm_math']]);
    //       // }
    //       // if (success[0]['alarm_card'] * 1 > 0) {
    //       //   tmp.push(['Card', success[0]['alarm_card']]);
    //       // }
    //       // let idx = Math.floor(Math.random() * tmp.length);
    //       // console.log('랜덤숫잨', idx);
    //       // console.log('tmp', tmp);
  ...
  handleBackPress() {
    console.log('뒤로가기 막는다~!!');
    return true;
  }
  UNSAFE_componentWillMount() {}
  componentDidMount() {}
  render() {
    console.log('zz', this.state.randomedInfo);
